...
import { AdminMenuTemplatesController } from './admin-menu-templates.controller';
import { AdminMenuTemplatesService } from './admin-menu-templates.service';
...
@Module({
  imports: [
    ...
    AdminAuthModule,
    // Same disk-storage rules as the shop image uploads.
  ...
  controllers: [AdminMenuTemplatesController],
  providers: [AdminMenuTemplatesService, PermissionGuard],
})
export class AdminMenuTemplatesModule {}
